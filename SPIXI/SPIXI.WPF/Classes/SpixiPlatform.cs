...
{
	public class SpixiPlatform : BindableObject, INavigation
#pragma warning disable CS0618
		, IPlatform
#pragma warning restore
	{
		readonly SpixiApplicationPage _page;
		Page Page { get; set; }

		internal static readonly BindableProperty RendererProperty = BindableProperty.CreateAttached("Renderer", typeof(IVisualElementRenderer), typeof(SpixiPlatform), default(IVisualElementRenderer));

		public SpixiPlatform(SpixiApplicationPage page)
		{
			_page = page;
