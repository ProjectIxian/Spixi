    ...
    class StreamClientManager
    {
        ...
        private static void connectToRandomStreamNode()
        {
            ...
            try
            {
                ...
                {
                    List<Presence> tmp_presences = presences.FindAll(x => x.addresses.Find(y => y.type == 'R' && (y.nodeVersion.StartsWith("xs2c-0.4."))) != null); // TODO tmp_presences can be removed after protocol is finalized
