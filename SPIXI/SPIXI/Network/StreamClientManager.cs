    ...
    class StreamClientManager
    {
        ...
        private static void connectToRandomStreamNode()
        {
            ...
            try
            {
                ...
                {
                    List<Presence> tmp_presences = presences.FindAll(x => x.addresses.Find(y => y.type == 'R' && (y.nodeVersion == "xs2c-0.4.0")) != null); // TODO tmp_presences can be removed after protocol is finalized
