Instructions and notes for translators:
- Reference language file is en-us.txt
- Language files must be saved in UTF-8 with BOM, it's best if you copy en-us.txt to a new file and start translating there
